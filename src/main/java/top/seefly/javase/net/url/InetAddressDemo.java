...
/**
 * 本类用来演示java是如何封装一个IP地址 可以用InetAddress 中的静态方法将网址封装成一个IP对象
 * <p>
 * PID 电脑中为每一个进程分配的一个ID，它不代表端口号 命令：netstat -nao 查看PID与对应的端口号 0-1024为系统保留，仅供系统进程使用的端口号。 1025-65535为程序使用
 *
 * @author liujianxin
 */
